...
class UnitTransformer:
    ...
    def __init__(
        self, degree_crs=pyproj.CRS("EPSG:4326"), meter_crs=pyproj.CRS("EPSG:5361")
    ):
...
def get_distance(origin: FloatCoordinate, destination: FloatCoordinate) -> float:
    point1 = Point(origin)
    point2 = Point(destination)
